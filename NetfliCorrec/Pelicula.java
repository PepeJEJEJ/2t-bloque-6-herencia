...
public class Pelicula extends Contenido {
    ...
    // Constructor corregido: incluye director
    public Pelicula(int idContenido, String titulo, int DuracionMin, String genero, boolean visto, boolean postCreditos, String director) {
        super(idContenido, titulo, DuracionMin, genero, visto);
        this.postCreditos = postCreditos;
        this.director = director;  // Ahora se asigna
    }
